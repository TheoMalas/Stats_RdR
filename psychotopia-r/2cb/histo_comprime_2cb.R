...
grey_list_coupe = list("Le comprimé de 193mg de 2C-B contient 6% de 2C-B (équivalent chlorhydrate). Il y a donc 12 mg de 2C-B au total dans le comprimé. "="12 mg de 2C-B") #Cas particulier
data <- data %>%
  mutate(
    coupe = ifelse(
