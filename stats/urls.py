...
urlpatterns = [
    ...
    path('purity-cocaine_test/', views.purity_cocaine_view_2, name='purity_cocaine_view_test'),
    path('purity-2cb/', views.purity_2cb_view, name='purity_2cb_view'),
    path('histo-comprime-2cb/', views.histo_comprime_2cb_view, name='histo_comprime_2cb_view'),
